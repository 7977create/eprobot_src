...
private:
    ros::NodeHandle n_;
    ros::Subscriber odom_sub, path_sub, goal_sub, resule_sub;
    ros::Publisher pub_, marker_pub, three_point_pub, cancle_pub;
...
L1Controller::L1Controller()
{
	...
	pn.param("ks_circle", ks_circle, 1.5);
	...
	pn.param("look_ahead_line", look_ahead_line, 0.2);
